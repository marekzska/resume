...
export function WorkPreview({ item, flip }: WorkPreviewProps) {
  ...
  return (
    <div
      className={cn(
        'pointer-events-none hidden aspect-[16/10] w-56 overflow-hidden rounded-md border border-hairline opacity-0 transition duration-500 ease-out group-hover:opacity-100 motion-safe:translate-y-3 motion-safe:group-hover:translate-y-0 lg:absolute lg:top-10 lg:block xl:w-64',
